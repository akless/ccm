...
( function () {
  ...
  var self = {
     ...
     */
    version: function () { return '11.4.1'; },
    ...
    load: function () {
      ...
      function loadResource( resource, i ) {
        ...
        function loadCSS() {
          ...
          var tag = { tag: 'link', rel: 'stylesheet', type: 'text/css', href: resource.url };
        ...
        function exchangeData() {
          ...
          function jsonp() {
            ...
            var tag = { tag: 'script', src: buildURL( resource.url, resource.params ) };
            if ( resource.attr ) self.helper.integrate( resource.attr, tag );
            tag = self.helper.html( tag );
