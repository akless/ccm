 ...
 * @version latest (11.5.0)
 * @changes
 * version 11.5.0 (18.10.2017): ccm.component(index):boolean checks if a component is already registered
 ...
 * version 11.4.0 (16.10.2017):
 * - ccm.instance is always asynchron (no return value)
 * - add help function 'ccm.helper.isSafari():boolean'
 ...
 * version 11.2.2 (13.10.2017): bugfix for embedding ccm instance in the same HTML element
 * version 11.2.1 (13.10.2017): bugfix for ccm.helper.solveDependency()
 * version 11.2.0 (11.10.2017):
 * - each ccm instance knows his own ccm dependency
 * - help function 'ccm.helper.solveDependency()' accepts dependency as first parameter
 * version 11.1.0 (11.10.2017):
 * - add help function 'ccm.helper.toJSON(*):*'
 * - bugfix for LightDOM access
...
( function () {
  ...
  var self = {
     ...
     */
    version: function () { return '11.5.0'; },
    ...
    load: function () {
      ...
      function loadResource( resource, i ) {
        ...
        function exchangeData() {
          ...
          var settings = { url: resource.original, data: resource.params, callback: successData };
