...
( function () {
  ...
  var self = {
     ...
     */
    version: function () { return '11.2.0'; },
    ...
    helper: {
      ...
      solveDependency: function ( obj, key, callback ) {
         ...
         * @type {ccm.types.action}
         */
        var action = self.helper.clone( key ? obj[ key ] : obj );
        ...
        action.push( function ( result ) {
          if ( key ) obj[ key ] = result;      // replace ccm dependency with the result of the solved dependency
          if ( callback ) callback( result );
        } );
